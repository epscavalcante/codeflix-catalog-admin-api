...
import CastMember, { CastMemberCreateCommand, CastMemberProps } from "../cast-member.aggregate";
...
describe("CastMember Unit Test", () => {
    ...
    describe("Without validation entity", () => {
        ...
        test ("deve alterar a o tipo", () => {
            ...
            castMember.changeType(new CastMemberType(CastMemberTypeEnum.DIRECTOR));
