...
import CastMemberMemoryRepository from './cast-member-memory.repository';
import CastMemberType from '@core/cast-member/domain/cast-member-type.value-object';

describe('CastMemberMemoryRepository', () => {
    let repository: CastMemberMemoryRepository;

    beforeEach(() => (repository = new CastMemberMemoryRepository()));
